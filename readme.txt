...
1. Test.py :  To run the test on the SVM model,  give the path of folder where test images are present in
test_images_path variable. Execute this python file. It will predict the human in the image by drawing bounding box around it.
